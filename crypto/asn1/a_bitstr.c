...
/**
 * Retrieve the length and unused bits from an ASN1_BIT_STRING.
 * On success, returns 1 and writes the length of the bit string to
 * |out_length| and the numbe of unused bits to |out_unused_bits|.
